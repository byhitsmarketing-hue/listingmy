...
foreach ( (array) $options['footer']['sections'] as $section ) {
    ...
    if ( $section['type'] === 'host' ) {
        ...
        <?php foreach ( $related_items as $key => $related_item ):
            ...
            $section['label'] = \MyListing\sanitize_preview_card_string( $section['label'], $listing );
            ?>
        ...
        <div class="listing-details-3 c27-footer-section">
            <ul class="details-list no-list-style">
                <?php foreach ( (array) $section['details'] as $detail ) {
                    ...
                    $string = \MyListing\sanitize_preview_card_string( $string, $listing );
                    $attributes = [];
                    $classes = [];
