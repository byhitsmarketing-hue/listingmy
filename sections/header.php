...
$mobile_menu_position = c27()->get_setting( 'header_mobile_menu_position', 'left' );
$data = c27()->merge_options([
	...
	'search_form_placeholder' => c27()->ml_t(
		c27()->get_setting('header_search_form_placeholder', 'Type your search...'),
		'theme-option.text',
		[ 'option_key' => 'header_search_form_placeholder' ]
	),
...
if ( $mobile_menu_position === 'right' ) {
	$header_classes[] = 'header-mobile-menu-right';
}
...
$header_skin_selector = '.c27-main-header.header.header-' . sanitize_html_class( $data['skin'] ) . '-skin:not(.header-scroll) .header-skin';

if ($data['background_color']) {
	if (!isset($GLOBALS['case27_custom_styles'])) $GLOBALS['case27_custom_styles'] = '';

	$GLOBALS['case27_custom_styles'] .= $header_skin_selector . ' ';
...
if ($data['border_color']) {
	...
	$GLOBALS['case27_custom_styles'] .= $header_skin_selector . ' { border-bottom: 1px solid ' . $data['border_color'] . ' } ';
}
			...
			<div class="header-right">
				<?php if ( is_user_logged_in() ): $current_user = wp_get_current_user(); ?>
					<div class="user-area">
						...
						<?php if ( (bool) get_option( 'options_messages_enabled' ) ): ?>
