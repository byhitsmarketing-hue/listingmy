<?php
	...
	$data = c27()->merge_options([
			...
			'footer_text'      => c27()->ml_t(
				c27()->get_setting('footer_text', ''),
				'theme-option.text',
				...
				<div class="footer-bottom">
					<div class="row">
						...
						<div class="col-md-12 col-sm-12 col-xs-12 copyright">
							<p><?php echo wp_kses_post( str_replace( '{{year}}', date('Y'), $data['footer_text'] ) ) ?></p>
						</div>
					</div>
				</div>
			</div>
