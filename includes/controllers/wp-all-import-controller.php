...
class Wp_All_Import_Controller extends Base_Controller {
	...
	protected function hooks() {
		...
		$this->filter( 'wp_all_import_set_post_terms', '@normalize_hierarchy_terms_before_assignment', 10, 4 );
	}
	...
	protected function normalize_hierarchy_terms_before_assignment( $assign_taxes, $taxonomy, $post_id, $import_id ) {
		return \MyListing\Apis\Wp_All_Import\normalize_hierarchy_term_assignment(
			$assign_taxes,
			$taxonomy,
			$import_id
		);
